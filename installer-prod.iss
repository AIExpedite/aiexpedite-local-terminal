...
AppId={{B8E4A9C1-7D3F-4E2B-9A1C-8F6E5D4C3B2A}
AppName={#MyAppName}
...
OutputBaseFilename=AIExpediteTerminal-Setup-{#MyAppVersionString}
...
; For prod, the registry key is just "AIExpedite" (no suffix)
Root: HKCU; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: string; ValueName: "AIExpedite"; ValueData: """{app}\{#MyAppExeName}"""; Flags: uninsdeletevalue; Tasks: startup
